...
async function runTests() {
    logger_1.logger.info('Starting TokenService tests...');
    // Test 1: Kiểm tra khởi tạo TokenService
    try {
        const provider = new providerPool_1.ProviderPool();
        const service = tokenService_1.TokenService.getInstance(provider);
        logger_1.logger.info('✅ Test 1 passed: TokenService initialized correctly');
    }
    catch (error) {
    ...
    try {
        ...
        logger_1.logger.info('✅ Test 2 passed: Token info fetched correctly');
    }
    catch (error) {
    ...
    try {
        ...
        logger_1.logger.info('✅ Test 3 passed: Pair info fetched correctly');
    }
    catch (error) {
    ...
    try {
        ...
        logger_1.logger.info('✅ Test 4 passed: Cache working correctly');
    }
    catch (error) {
    ...
    try {
        ...
        logger_1.logger.info('✅ Test 5 passed: Stats updated successfully');
    }
    catch (error) {
